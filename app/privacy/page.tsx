    ...
    <main className="mx-auto max-w-6xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <div className="prose prose-slate mt-10 max-w-3xl prose-headings:font-semibold prose-headings:text-navy prose-a:text-teal prose-a:no-underline hover:prose-a:underline">
        <section className="space-y-4 text-sm text-slate-700">
          ...
          <p>
            We may collect information that you provide directly, such as when you
            contact us, submit a form, or sign up for a featured listing. This may
            include your name, email address, phone number, business details, and any
            message content. We also automatically collect certain technical information
            when you visit our site, such as your IP address, browser type, device
            information, and pages visited, which may be collected through cookies or
            similar technologies.
          </p>

          <h2 className="text-lg font-semibold text-navy">3. How We Use Your Information</h2>
          <p>
            We use the information we collect to operate and improve our directory,
            respond to your inquiries, process featured or premium listing requests,
            send relevant updates (if you have opted in), and analyze site usage to
            improve the user experience. We do not sell your personal information to
            third parties.
          </p>
          ...
          <p>
            ...
            update or remove your listing, contact us at {DIRECTORY_SUPPORT_EMAIL}.
          </p>
          ...
          <p>
            ...
            understand how the site is used, and improve performance. You can adjust your
            browser settings to refuse or limit cookies, though some features may not
            work as intended.
          </p>

          <h2 className="text-lg font-semibold text-navy">6. Third-Party Links and Services</h2>
          <p>
            Our site may contain links to third-party websites (e.g., firm websites,
            Google Maps, payment processors). We are not responsible for the privacy
          ...
          <p>
            ...
            processing. To exercise these rights or ask questions about your data,
            contact us at {DIRECTORY_SUPPORT_EMAIL}.
          </p>
          ...
          <p>
            ...
            updated&quot; date at the top will reflect the most recent version. Continued
